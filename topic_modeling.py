...
class Topic():
    def __init__(self):
        ...
        self.sTicketDataFile="/home/ubuntu/AIAP_experiments/ABCNN_v1/mockdata.csv"
        self.epoch=1000
...
# training set, bag of self.words for each sentence
        ...
        self.model.save('/home/ubuntu/AIAP_experiments/ABCNN_v1/tp_model/model_Topic.tflearn')
        pickle.dump( {'words':self.words, 'classes':self.classes, 'train_x':train_x, 'train_y':train_y}, open( "/home/ubuntu/AIAP_experiments/ABCNN_v1/Path_training_data", "wb" ) )


    def reloadModelAndData(self):
        data = pickle.load( open("/home/ubuntu/AIAP_experiments/ABCNN_v1/Path_training_data", "rb" ) )
...
# load our saved model
        self.model.load('/home/ubuntu/AIAP_experiments/ABCNN_v1/tp_model/model_Topic.tflearn')
